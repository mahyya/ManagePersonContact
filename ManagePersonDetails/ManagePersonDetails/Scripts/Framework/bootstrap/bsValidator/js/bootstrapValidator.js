    ...
    BootstrapValidator.prototype = {
        ...
        showError: function ($field, validatorName) {
            ...
            try {
                ...
                if (field == "chkTandC") {
                    ...
                    $('#chktc').html(message).show();
                }
                else {

                    var cls = this.options.errorPosClass;
                    if (cls != "") {
                        $field.data('bootstrapValidator.error').addClass(cls);
                    }
        ...
        */
        removeError: function ($field) {
            ...
            try {
                if ($field.data('bootstrapValidator.error') != null) {
...
;(function($) {
    $.fn.bootstrapValidator.validators.between = {
        ...
        validate: function(validator, $field, options) {
            var value = $field.val();
            var atrVal = $field.attr('placeholder');
            if (value == atrVal) { value = ""; }
            if (value == '') {
                return true;
            }
            var arr = value.split(".");
...
;(function($) {
    $.fn.bootstrapValidator.validators.stringLength = {
        ...
        validate: function(validator, $field, options) {
            var value = $field.val();           
            if (value == '' || value == $field.attr('placeholder')) {         
                return true;
            }
